...
class _TagManagementDialogState extends State<TagManagementDialog> {
  late final Box<Tag> _tagsBox = widget.tagsBox ?? Hive.box<Tag>(StorageConstants.tagsBox);
  late final Box<ImageStory> _storiesBox = widget.imageStoriesBox ?? Hive.box<ImageStory>(StorageConstants.imageStoriesBox);
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: SizedBox(
        ...
        height: 400, // Fixed height to prevent unbounded constraint issues
        child: Column(
          children: [
            TextField(
              decoration: InputDecoration(
