...
| 7 | **Dual-Mode Save Logic & Localization** | [x] Complete (2/2 plans) | Implement save dialog ("Päivitä olemassa oleva" vs "Tallenna uutena") with full trilingual localization. | SAVE-01, SAVE-02 | 5 criteria |
