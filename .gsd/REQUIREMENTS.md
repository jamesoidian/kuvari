...
| REQ-05 | Display a list of tags/folders in the saved stories view for filtering. | SPEC Goal 1 | Pending |
| REQ-06 | Persistence of tags and mappings in Hive local storage. | SPEC Goal 4 | Pending |
| REQ-07 | Deleting a tag should not delete the stories associated with it. | General | Pending |
